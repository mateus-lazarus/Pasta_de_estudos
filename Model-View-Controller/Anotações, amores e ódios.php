...
Aprender APIs de Senhas do PHP
...
Sessões são informações guardadas em cookies no navegador que são persistidos (e se for a função deles) enviados com cada 
 requisição feita para o servidor, identificando o usuário.
...
Conceito de mensagens (ou outros cookies) que somente duram uma única requisição
...
TRAIT (Herança Horizontal)

https://www.php.net/manual/pt_BR/language.oop5.traits.php


hierarquia de membros (funções ou variáveis) é HERANÇA < TRAIT < CLASSE EM SI-
...
As recomendações de padrões a serem seguidos enquanto escrevendo em PHP
